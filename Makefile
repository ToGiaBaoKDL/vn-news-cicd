...
.PHONY: install lock validate lint format format-check test prepare-release build-images push-images bootstrap-ingestion bootstrap-storage bootstrap-topics register-event-schemas
